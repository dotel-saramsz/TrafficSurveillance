"""
Django settings for trafficsurveillance project.
...
SECRET_KEY = 'e4j8r%ek)n&8^zc^lk&n^)^ryj@vxhwtyoez*$xzp9q57m9l2t'
...
ROOT_URLCONF = 'trafficsurveillance.urls'
...
WSGI_APPLICATION = 'trafficsurveillance.wsgi.application'
